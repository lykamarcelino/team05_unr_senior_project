...
public class DashGraph {
    ...
    private String graphType = new String();
    ...
    public DashGraph(List<String> labels, List<Double> data, List<String> colors, String legendPosition, String title,
                     String xAxisTitle, String yAxisTitle, String dataLabel, Boolean showLegend ,String graphType, Boolean fill) throws Exception {
    ...
    public void setGraphData(List<String> labels, List<Double> data, List<String> colors, String legendPosition, String title,
                             String xAxisTitle, String yAxisTitle, Boolean showLegend, String dataLabel, String graphType, Boolean fill) throws Exception {
        if(checkData(labels, data) == false){
            throw new Exception("ERROR: invalid data entry");
        }
